...
2. **Set Up the Database**: on your workbook create database and table (create DB and table Query in 'sql_query_p1.sql')after in that table import  `Retail sales analysis_utf.csv` 
...
## Dataset File  (.csv)
<a href="https://github.com/harmishaborisaniya-cloud/Retail-Sales-Analysis-SQL-Project--P1/blob/main/SQL%20-%20Retail%20Sales%20Analysis_utf%20.csv">Data_set</a>
